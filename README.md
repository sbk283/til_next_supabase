...
- 반드시 @import 는 css 첫줄이어야함
- tailwind 4.x 버전이므로 `@import "tailwindcss";` 가 무조건 들어간다.
...
```bash
git remote add origin https://github.com/(깃허브주소)
git remote add origin https://github.com/sbk283/til_next_supabase.git
```
